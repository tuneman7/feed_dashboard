                ...
                if not pipeline_name.strip():
                    ...
                    try:
                        if mode == "Add":
                            ...
                            SET pipeline_name = %s, pipeline_type_cd = %s, pipeline_status_id = %s, pipeline_description = %s, is_active = %s
                            WHERE pipeline_id = %s;
                            """
                            params = (pipeline_name, pipeline_type, pipeline_status, pipeline_desc, is_active, pipeline_id)
